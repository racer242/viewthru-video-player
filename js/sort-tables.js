...
$(document).ready(function() {
    loadAllTableText();
    addEventListeners();
    if($('.tablesort .header td.tablesort-default').length) {
        $('.tablesort .header td.tablesort-default').trigger('click');
    }
});

function addEventListeners() {
    $('body').on('click', '.tablesort .header td', function() {
        tableSort(this);
    });
...
function tableSort(thClicked) {
    ...
    if ($(thClicked).hasClass('tablesort-asc')) {
        $(table).find('thead .header td').removeClass('tablesort-asc').removeClass('tablesort-desc');
